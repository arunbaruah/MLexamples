...
# Predict product purchase for Bank Telemarketing dataset from UCI repo
import pandas as pd

# Read the file
f = pd.read_csv('bankdataset.csv')
...
# Fit the Random Forest classifier to the new train and test 
